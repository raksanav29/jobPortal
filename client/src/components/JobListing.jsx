    ...
    <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row py-8'>
      ...
      <div className='w-full lg:w-1/4 bg-white px-4'>
        ...
        <button
          ...
          className='block lg:hidden w-full border border-gray-400 px-4 py-2 mb-4 rounded'
        >
        ...
        {isSearched && (searchFilter.title || searchFilter.location) && (
          <>
            ...
            <div className='mb-4 text-gray-600'>
              ...
              {searchFilter.location && (
                <span className='ml-2 inline-flex items-center gap-2 bg-red-50 border border-red-200 px-3 py-1 rounded'>
                  {searchFilter.location}
                  <img
      ...
      {/* JOB LIST */}
      <section className='w-full lg:w-3/4 px-4' id="job-list">
